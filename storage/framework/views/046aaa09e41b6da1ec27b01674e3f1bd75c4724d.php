...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(url('/')); ?>/public/assets/images/logo/Favicon.png">
    <!-- BEGIN: Theme CSS-->
     <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(url('/')); ?>/public/assets/images/logo/Favicon.png">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/vendors/css/vendors.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/bootstrap-extended.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/colors.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/components.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/sweply-user.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
    <script src="<?php echo e(url('/')); ?>/public/assets/vendors/js/vendors.min.js"></script>
    <script src="<?php echo e(url('/')); ?>/public/assets/vendors/js/charts/apexcharts.min.js"></script>    
    <script src="<?php echo e(url('/')); ?>/public/assets/js/scripts/components.js"></script>
    <!-- <script src="<?php echo e(url('/')); ?>/public/assets/vendors/js/extensions/jquery.steps.min.js"></script> -->
    <!-- <script src="<?php echo e(url('/')); ?>/public/assets/js/scripts/forms/wizard-steps.js"></script> -->
    <script src="<?php echo e(url('/')); ?>/public/assets/vendors/js/pickers/pickadate/picker.js"></script>
    <script src="<?php echo e(url('/')); ?>/public/assets/vendors/js/pickers/pickadate/picker.date.js"></script>
    <!-- <script src="<?php echo e(url('/')); ?>/public/assets/js/scripts/pickers/dateTime/pick-a-datetime.js"></script> -->
    <script src="<?php echo e(url('/')); ?>/public/assets/vendors/js/forms/select/select2.full.min.js" defer></script>
    <script src="<?php echo e(url('/')); ?>/public/assets/js/scripts/forms/select/form-select2.js" defer></script>  
...
<body class="container-main vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static <?php echo $THEMEUI; ?> " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" >
                    ...
                    <div class="navbar-container content">
                        <div class="navbar-collapse" id="navbar-mobile">
                            <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center hide-for-mobile">
                                ...
                                <ul class="nav navbar-nav">
                                    <li>
                                        <div class="create-btn"><a href="<?php echo e(url('/')); ?>/user/create-ads/">Create Ads</a></div>
                                        <a class="buy-twitter-credits-btn" href="<?php echo e(url('/')); ?>/user/demo/">Buy twitter credits</a>
                                    </li>                                    
                                </ul>
                            </div>
                            <ul class="nav navbar-nav float-right">
                                ...
                                <li class="dropdown dropdown-notification nav-item responsive-float-right">
                                    <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                                        ...
                                        <span class="badge badge-pill badge-primary badge-up"><?php echo e($notificationArr['count']); ?></span>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                        <li class="dropdown-menu-header">
                                            <div class="dropdown-header m-0 p-2">
                                                <h3 class="white"><?php echo e($notificationArr['count']); ?> New</h3><span class="notification-title">App Notifications</span>                                                    
                                            </div>
                                        </li>
                                ...
                                <li class="dropdown dropdown-user nav-item hide-for-mobile">
                                    <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                    					...
                    					<img class="round" src="<?php echo e(url('/')); ?>/public/assets/images/profile.png" alt="avatar" height="40" width="40">

                    					<?php }else{ ?>

                    					<img class="round" src="<?php echo e(url('/')); ?>//uploads/user_image/<?php echo $userData["profile_photo"]; ?>" alt="avatar" height="40" width="40">
                    					<?php } ?></span>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item"
                                                href="<?php echo e(url('/')); ?>/user/profile"><i class="feather icon-user"></i> Edit Profile</a>
    ...
    <div class="modal fade text-left defaultSize-modal modal-padding-change" id="upgrade-account" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('/')); ?>/user/upgrade-account" method="POST" id="accountUpgradeFrm" enctype="multipart/form-data">
    ...
    <div class="responsive-menu-section">
        ...
        <ul>
            ...
            <li><a href="<?php echo e(url('/')); ?>/user/dashboard/"><span><i class="fal fa-home"></i></span>Home</a></li>

            <li class="responsive-search"><a href="<?php echo e(url('/')); ?>/user/wallet-list/"><span><i class="fal fa-wallet"></i></span>Wallet</a></li>
            <li class="add-ads-btn">
                <a href="<?php echo e(url('/')); ?>/user/create-ads/">
            ...
            <li class="respo-cart-menu">                
                <a class="head-cart-box" href="<?php echo e(url('/')); ?>/user/campaign/">
    ...
    $(document).ready(function(){
        $('.validate-frm-upgrade').click(function(){
           ...
           /* if(flag==0){
                $.ajax({
                 type: "POST",
                  url: "<?php echo e(url('/')); ?>/user/upgrade-account",
...
<?php } ?> <?php /**PATH C:\xampp\htdocs\sweply\resources\views/front/layout/dashboard-header.blade.php ENDPATH**/ ?>