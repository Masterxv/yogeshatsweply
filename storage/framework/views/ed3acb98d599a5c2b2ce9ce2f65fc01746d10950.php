...
<?php $__env->startSection('main_content'); ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">                       
                                            <div style="position: relative;" class="profile-img-block">
                                                <div class="pro-img"><img src="<?php echo e($userData->profile_photo); ?>" class="img-responsive img-preview" alt=""/></div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter First Name" class="form-control" id="first_name" name="first_name" value="<?php echo e($userData->first_name); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <label for="last_name">Last Name</label>
                                            <input type="text" placeholder="Enter Last Name" class="form-control" id="last_name" name="last_name" value="<?php echo e($userData->last_name); ?>">
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group change-btn-form-group">
                                            ...
                                            <div style="position: relative">
                                                <input style="padding-left: 110px;" type="text" placeholder="Enter  Mobile Number " class="form-control" id="contact_number" name="contact_number" value="<?php echo e($userData->contact_number); ?>" disabled="true">
                                                <!-- <span class="mobile-no-pro"><?php echo e($userData->contry_code); ?></span> -->
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group change-btn-form-group">
                                            ...
                                            <input type="text" placeholder="Enter Email" class="form-control" id="email" name="email" value="<?php echo e($userData->email); ?>">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <!-- <input type="text" placeholder="Enter  Occupation Name " class="form-control" id="occupation" name="occupation" value="<?php echo e($userData->occupation); ?>"> -->
                                        </div>
                                    </div>      
                                    ...
                                    <!-- <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Age" class="form-control" id="age" name="age" value="<?php echo e($userData->age); ?>">
                                        </div>
                                    </div> -->
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <label>Date Of Birth <span style="color: red">*</span></label>
                                            <input name="DOB" placeholder="Select date of birth" type='text' class="form-control datepicker" value="<?php echo e($userData->DOB); ?>" autocomplete="off" />
                                        </div>
                                    </div>
                                </div>
    ...
    function update_profile(){
            ...
            jQuery.ajax({
                url: "<?php echo e(url('/')); ?>/user/update_profile",
                ...
                success: function (data) {
                    ...
                    if(data != ''){
                        swal("Thank You!", "User Profile Updated successfully!", "success")
                            .then((value) => {
                                location.href = "<?php echo e(url('/')); ?>/user/profile/";
                        });
                    }else{
...
<?php echo $__env->make('front.layout.dashboard-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sweply\resources\views/front/user/profile.blade.php ENDPATH**/ ?>