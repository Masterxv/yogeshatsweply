...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/public/assets/css/fontawesome-v5.7.2-pro.min.css" />
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/public/assets/css/swiper.min.css">
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/public/assets/css/sweply-home.css">
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/public/assets/css/animate.css">
    <!--Custom Css-->
    <!--Main JS-->
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/public/assets/js/jquery-1.11.3.min.js"></script>
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/public/assets/js/bootstrap.min.js"></script>
    <link rel="icon" href="<?php echo e(url('/')); ?>/public/assets/images/logo/favicon.png" type="image/x-icon" />
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">

    <?php if(App::getLocale()=='ar'){ ?>
        <link rel="stylesheet" href="<?php echo e(url('/')); ?>/public/assets/css/swiply-rtl.css">
    ...
    <div class="header-main home-page-header">
        ...
        <div class="header-box">
            <div class="logo-block" data-wow-delay="0.2s">
                <a href="<?php echo e(url('/')); ?>/" class="black-logo"><img src="<?php echo e(url('/')); ?>/public/assets/images/logo.png" alt=""></a>               
            </div>
            ...
            <div id="mySidenav" class="sidenav">   
                ...
                <ul class="min-menu">
                    ...
                    <li class="campign-btn"><a href="<?php echo e(url('/')); ?>/login"><span>Start a campaign</span></a></li>                    
                </ul>
            </div>
            <div class="clearfix"></div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\sweply\resources\views/front/layout/header.blade.php ENDPATH**/ ?>