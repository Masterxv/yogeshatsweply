            ...
            <div class="breadcrem-section">
                ...
                <div class="brea-bx">
                    <ul>
                        ...
                        <li><a href="<?php echo e(url('/')); ?>/user/campaign">Twitter </a></li>                       
                    </ul>                </div>
							...
							if($data['preview_type']=="carousel" && isset($data['campaign_media_croped'])){
								...
								<div class="images-video-section-main">
				                    <div class="add-img-video-section"> 
				                        ...
				                        <?php }else{ ?>
				                        	<img src="<?php echo e($data['post_image']); ?>" id="ad_image"/>
				                        <?php } ?>                
				                    </div> 
				                    ...
				                    <div class="app-add-prive-main app-sec-preview">
				                        <div class="app-add-prive">
				                            ...
				                            <div class="app-add-install-btn" style="text-align:center;">
				                                <?php echo e($data['call_to_action']); ?>
...
<?php echo $__env->make('front.layout.dashboard-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sweply\resources\views/front/campaign/twitter/twitter-details.blade.php ENDPATH**/ ?>