...
<?php if(!isset($userData)){$userData = []; } ?>
                            ...
                            <div style="height: 229px;min-height: auto;" class="card bg-analytics text-white">
                                <div class="card-content">
                                    <div class="card-body text-center dash-name-section">
                                        ...
                                        <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/decore-right.png" class="img-right" alt="
                                           card-img-right">
                                ...
                                <div class="wallet-balance-bx">
                                    ...
                                    $walletData = getUserWalletBalance($userData["id"]); ?>    
                                        <div class="sar-amt-img">                   
                                            <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/wallet-balance.svg" alt="">                           
                                        </div>
                            ...
                            <div class="card wallet-bx">
                                <div class="wallet-sub-bx manager-information">
                                    <div class="wallet-icon-bx">
                                       <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/avatar-s-1-old.jpg" alt=""/>
                                    </div>  
                                    <div class="sar-amt-main">                                  
    ...
    <!-- <div class="drag-target"></div> -->
        <script src="<?php echo e(url('/')); ?>/public/assets/js/scripts/pages/dashboard-analytics.js"></script>
...
<?php echo $__env->make('front.layout.dashboard-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sweply\resources\views/front/user/dashboard.blade.php ENDPATH**/ ?>