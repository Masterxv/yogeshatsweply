...
<link rel="stylesheet" href="<?php echo e(url('/')); ?>/public/assets/css/sweply.css">
<style>
    ...
    <div class="signup-section-main front-otp-login-main">
        <div class="login-bg-pink">
            <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/login-bg/login-bg-pink.png" alt="" />
        </div>
        <div class="login-bg-blue">
            <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/login-bg/login-bg-blue.png" alt="" />
        </div>
        <div class="login-bg-yellow-small">
            <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/login-bg/login-bg-yellow-small.png" alt="" />
        </div>
        <div class="login-bg-yellow-big">
            <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/login-bg/login-bg-yellow-big.png" alt="" />
        </div>
        <div class="container" style="height: 100%;">
            <div class="signup-form-section login-form-main otp-step-one">                
                ...
                <div class="signup-form-semihead">
                    ...
                    <form method="POST"  id="login_frm" action="<?php echo e(url('/')); ?>/process_login">            
                    <div class="row">
                                    ...
                                    <span class="number-flag-id">
                                        <div class="dropdown">
                                            <button class="btn btn-warning dropdown-toggle mr-1 waves-effect waves-light" type="button" id="dropdownMenuButton5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: 0;background: none;font-size: 14px">
                                                <span style="display: inline-block;vertical-align: middle;" class="arabic-dd"><img src="<?php echo e(url('/')); ?>/public/assets/images/logo/flag-arb.png" alt="" class="contry-flag" />
                                                </span>

                                                <span style="display: none;vertical-align: middle;" class="india-dd"><img src="<?php echo e(url('/')); ?>/public/assets/images/logo/flag-india.png" alt="" class="contry-flag" />
                                                </span>

                                                <span style="display: none;vertical-align: middle;" class="usa-dd"><img src="<?php echo e(url('/')); ?>/public/assets/images/logo/flag-usa.jpg" alt="" class="contry-flag" />
                                                </span>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton5" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 37px, 0px);margin-left: -10px;">
                                                <a class="dropdown-item" id="arabic-dd" href="javascript:void(0);">
                                                    <span style="display: inline-block;vertical-align: middle;" ><img src="<?php echo e(url('/')); ?>/public/assets/images/logo/flag-arb.png" alt="" /></span> 
                                                    <span  style="display: inline-block;vertical-align: middle;">+966</span>
                                                </a>
                                                <a class="dropdown-item" id="india-dd" href="javascript:void(0);">
                                                    <span style="display: inline-block;vertical-align: middle;"><img src="<?php echo e(url('/')); ?>/public/assets/images/logo/flag-india.png" alt="" /></span> 
                                                    <span  style="display: inline-block;vertical-align: middle;">+91</span>
                                                </a>
                                                <a class="dropdown-item" id="usa-dd" href="javascript:void(0);">
                                                    <span style="display: inline-block;vertical-align: middle;"><img src="<?php echo e(url('/')); ?>/public/assets/images/logo/flag-usa.jpg" alt="" /></span> 
                ...
                <div class="dont-have-account-section">
                    Don't have an account? <a href="<?php echo e(url('/')); ?>/signup">Sign Up</a>
                </div>
            </div>
            <div class="signup-form-section login-form-main otp-screen-section-main" style="display: none;">
                ...
                <div class="otp-send-img">
                    <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/smartphone-message.png" alt="" />
                </div>
                <div class="signup-form-semihead">
        ...
        <!-- <div class="login-man-img">
            <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/Signup-man.png" alt="" />
        </div> -->
    </div>
...
function getOTP(){
    ...
    if(jQuery('#contact_number').val()){
        ...
        jQuery.ajax({
            url: "<?php echo e(url('/')); ?>/verify_contact",
            ...
            success: function (data) {
                if($.trim(data) == 'success'){
                    ...
                    .then((value) => {
                        location.href = "<?php echo e(url('/')); ?>/signup/";
                    });
                }
...
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sweply\resources\views/front/user/login.blade.php ENDPATH**/ ?>