                                ...
                                <div class="col-6">
                                    <div class="search-action-btn">
                                            ...
                                            <div class="btn-group">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton5" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 37px, 0px);">
                                                        ...
                                                        <a class="dropdown-item sort-btn" rel="week" href="#">Week</a>
                                                        <a class="dropdown-item sort-btn" rel="month" href="#">Month</a>
                                                        <a class="dropdown-item sort-btn" rel="year" href="#">Year</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="" style="margin-top: -3px;">
                                            <a href="<?php echo e(url('/')); ?>/user/create-ads" class="btn btn-primary add-form-btn btn-add-bussiness" >
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
              url: "<?php echo e(url('/')); ?>/user/load-campaign",
              data: function (d) {
                    d.status = $('#status').val(),
    ...
    function update_payment_status(status){
		...
		if(recordID){
            //alert(recordID);
			$.ajax({
	            url:'<?php echo e(url("/")); ?>/user/campaign_payment_status',
	            type :'post',
...
<div class="modal fade text-left defaultSize-modal modal-padding-change balance-modal-section" id="paymentMethodForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('/')); ?>/user/payment/" method="GET" id="payment_confirm_popup">
                <input type="hidden" id="campaign_id" name="campaign_id" />
                <!-- <?php echo csrf_field(); ?> -->
...
<?php echo $__env->make('front.layout.dashboard-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sweply\resources\views/front/campaign/campaign-list.blade.php ENDPATH**/ ?>