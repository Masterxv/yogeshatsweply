...
<link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/croppie/croppie.css" />
<link rel="Stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/croppie/prism.css" />
<link rel="Stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/croppie/demo.css" />
    ...
    <div class="breadcrem-section head-top">
                ...
                <div class="brea-bx">
                    <ul>
                        ...
                        <li><a href="<?php echo e(url('/')); ?>/user/create-ads">Create Ads <i class="fal fa-angle-right"></i></a></li>
        ...
        <div class="preview-ad-section twitter-ad-main-section">
            ...
            <div class="ad-prive-bx">
                <form action="<?php echo e(url('/')); ?>/user/twitter_store" class="number-tab-steps wizard-circle" id="twitter_creat" name='twitter_creat' enctype="multipart/form-data">
                    <!-- Step 1 -->
                    <?php
                    $channel_id = 0;
                ...
                ?>
                    ...
                    <input type="hidden" id="channel_id" name="channel_id"  value="<?php echo e($channel_id); ?>"/>
                    <input type="hidden" id="channel_category_id" name="channel_category_id"  value="<?php echo e($channel_category_id); ?>"/>
                    <?php
                    ...
                    ?>
                <!------------------------------- STEP 1-------------------------------------->
                    <input type="hidden" value="<?php echo e($walletBalance); ?>" name="wallet_amount" id="wallet_amount" />
                    <fieldset id="step-1">
                                ...
                                <div class="form-group image-media">
                                    <div class="radio-btns campaign-radio-section">
                                        <div class="radio-btn" id="browse-image">
                                            ...
                                            <label for="k-option">
                                                <div class="campaign-img">
                                                    <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/icon-img.png" alt="" />
                                                </div>
                                                 Photo
                                        ...
                                        <div class="radio-btn addMultiImages"  id="addMultiImages">
                                            ...
                                            <label for="e-option">
                                                <div class="campaign-img">
                                                    <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/icon-slider.png" alt="" />
                                                </div>
                                                Carousel
                                ...
                                <div class="form-group image-input uploaded-img-section" style="display:none;">
                                    ...
                                    <div class="uploaded-img-main square-img">
                                        <div class="uploaded-img">
                                            <img id='original_file_display' src="<?php echo e(url('/')); ?>/public/assets/images/logo/mobile-priview-img.jpg" />
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group bud-sar-padding">
                                            ...
                                            <input type="text" placeholder="Enter Budget" class="form-control" id="campaign_budget" value="0" name="campaign_budget" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
            ...
            <div class="ad-prive-bx preview-ads-mobile twitter-preview-main" id="preview-section-bx">
                ...
                <!-- <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/mobile.png" alt="" class="mobile-bg-img"/> -->
                ...
                <div class="images-video-section-main">
                    <div class="add-img-video-section">
                        <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/twetter-default-img.jpg" alt="" id="ad_image"/>
                        ...
                        <div class="app-add-prive">
                            <div class="app-add-icon-txt">
                                <div class="app-add-icon">
                                    <img src="<?php echo e(url('/')); ?>/public/assets/images/logo/app-icon.png" id="app-ico">
                                </div>
...
<!------------------------------- Campaign Script Start ------------------------->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/core/colors/palette-gradient.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/pages/dashboard-analytics.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/pages/card-analytics.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/plugins/tour/tour.css">
    <!-- END: Page CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/fontawesome-v5.7.2-pro.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/css/plugins/forms/wizard.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/assets/vendors/css/pickers/pickadate/pickadate.css">
    <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
    <script src="<?php echo e(url('/')); ?>/public/assets/vendors/js/pickers/pickadate/picker.js"></script>
    <script src="<?php echo e(url('/')); ?>/public/assets/vendors/js/extensions/nouislider.min.js"></script>
    <script src="<?php echo e(url('/')); ?>/public/assets/js/scripts/jquery-ui.js"></script>
    <script src="<?php echo e(url('/')); ?>/public/assets/js/scripts/jquery.ui.touch-punch.min.js"></script>
    <script src="<?php echo e(url('/')); ?>/public/assets/vendors/js/forms/spinner/jquery.bootstrap-touchspin.js"></script>
    <script src="<?php echo e(url('/')); ?>/public/assets/js/scripts/forms/number-input.js"></script>
    <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/public/assets/croppie/croppie.js" defer></script>
	<script type="text/javascript" src="<?php echo e(url('/')); ?>/public/assets/croppie/demo.js"></script>
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/public/assets/js/htmltocanvas.js"></script>
...
<?php }  ?>
    ...
    $(function() {
        ...
        $('.close-img').click(function(){
            ...
            $('#ad_image').attr('src',"<?php echo e(url('/')); ?>/public/assets/images/logo/twetter-default-img.jpg");
        });
                            ...
                            <div class="audience-gender-bx payment-method-wallet">
                                <div class="gender-chk-bx">
                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                        ...
                                        <span class=""><span class="checkbox-span"><i class="fal fa-wallet"></i></span> Wallet Balance :<i class="wallet_amount_opt" style="font-weight: 600;color:#399dd6; " ><?php echo e($walletBalance); ?></i> </span>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
...
<!-- Link Swiper's CSS -->
<link rel="stylesheet" href="<?php echo e(url('/')); ?>/public/assets/css/swiper.min.css">
<!-- Swiper JS -->
...
<script>
    ...
    function saveCampaignData(){
        ...
        html2canvas($('#preview-section-bx'),{background: '#fff'}).then(function(canvas) {
            ...
            jQuery.ajax({
                url: "<?php echo e(url('/')); ?>/user/twitter_store",
                dataType: 'text',
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function (data) {
                    if($.trim(data) == 'success'){
                        swal("Thank You!", "Campaign created successfully!", "success")
                            .then((value) => {
                                $('.loader-section-main').show();
                                location.href = "<?php echo e(url('/')); ?>/user/campaign/";
                        });
                        ...
                        location.href = "<?php echo e(url('/')); ?>/user/payment/";
                    }else{
...
<?php echo $__env->make('front.layout.dashboard-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sweply\resources\views/front/campaign/twitter/create.blade.php ENDPATH**/ ?>