...
$ACCESS_PWD='sweply@123'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

#DEFAULT db connection settings
# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
$DBDEF=array(
'user'=>"wingdemo_sweply",#required
'pwd'=>"Unimark@@2021", #required
'db'=>"wingdemo_sweply",  #optional, default DB
