	...
	<div class="content-wrapper">
		<div class="preview-ad-section ad-prive-details-bx-main">
            <div class="breadcrem-section">
                <h2><i class="fa fa-youtube" title="youtube"></i>YouTube Ad Details</h2>
                <div class="brea-bx">
                    <ul>
                        <li><a href="{{url('/')}}/user/dashboard">Home <i class="fal fa-angle-right"></i></a></li>                        
                        <li><a href="{{url('/')}}/user/campaign">Youtube </a></li>                       
                    </ul>                </div>
			...
			<div class="ad-prive-bx ad-prive-details-bx">
				...
				<div class="col-sm-4 col-md-4 col-lg-4">
					<div class="ad-prive-bx preview-ads-mobile youtube-preview-main" id="preview-section-bx">  
		                ...
		                <div class="company-user-details">
		                    <div class="company-user-details-icon"> <i class="fa fa-youtube" title="youtube"></i> </div>
		                ...
		                <?php 
							...
							if($data['preview_type']=="carousel" && isset($data['campaign_media_croped'])){
								...
								<div class="slider-img-video-section" >
									<div class="swiper-container images-slider-youtube">
...
<script>
    ...
    function initSlder(){
        swiper = new Swiper('.images-slider-youtube', {
          slidesPerView: 1,
          spaceBetween: 1,
          centeredSlides: true,  
          loop:true, 
