		...
		<div class="preview-ad-section ad-prive-details-bx-main">
			...
			<div class="ad-prive-bx ad-prive-details-bx">
				...
				<div class="col-sm-4 col-md-4 col-lg-4">
					<div class="ad-prive-bx preview-ads-mobile google-preview-main" id="preview-section-bx">  
		                ...
		                <div class="company-user-details">
		                    <div class="company-user-details-icon"> <i class="fa fa-google" title="google"></i> </div>
		                ...
		                <?php 
							...
							if($data['preview_type']=="carousel" && isset($data['campaign_media_croped'])){
								...
								<div class="slider-img-video-section" >
									<div class="swiper-container images-slider-google">
...
<script>
    ...
    function initSlder(){
        swiper = new Swiper('.images-slider-google', {
          slidesPerView: 1,
          spaceBetween: 1,
          centeredSlides: true,  
          loop:true, 
