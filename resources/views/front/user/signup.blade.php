            ...
            <div class="container">
                <div class="signup-form-section">
                    ...
                    <div class="form-group mobile-number-section">
                            ...
                            <div class="varifi-code-send-txt alert alert-success" style="display:none;"><i class="fas fa-check-circle"></i> &nbsp; Please enter code sent to <span class="short-mobileno">******0687</span></div>
                        </div>  
                    ...
                    <div class="dont-have-account-section timer-sec"  style="display:none;">           
                        <div >
                            ...
                            <a href="javascript:void(0);" onclick="resendOTP()" class="otp-resend disabled">Resend OTP</a> 
                            or <a href="javascript:void(0);" class="otp-resend change-mobno disabled">Change mobile number</a>
                        </div> 
                    </div>

                    <div class="check-box confirm-acc" style="display:none;">
...
$(".dropdown-toggle").on("click", function(){
    ...
    $('.change-mobno').click(function(){
        ...
        $('.verify-otp').hide();
        $('.varifi-code-send-txt').show();
        $('.varifi-code-send-txt.alert').hide();
        $('.timer-sec').hide();
