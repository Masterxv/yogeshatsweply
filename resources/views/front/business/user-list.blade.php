		...
		<div class="modal-content">
			...
			<form action="{{url('/')}}/user/create-business-user" method="POST" id="businessFrm">
				...
				<div class="modal-body">
					...
					<div class="form-group add-user-contact-num">
							...
							<span class="number-flag-id">
								<div class="dropdown">
									<button class="btn dropdown-toggle mr-1 waves-effect waves-light" type="button" id="dropdownMenuButton5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: 0;background: none;font-size: 14px">
										...
										<span class="india-dd contry-code" style="display:none;vertical-align: middle;color: #000000">+91</span>
										<span class="usa-dd contry-code" style="display:none;vertical-align: middle;color: #000000">+1</span>
										<span class="arabic-dd contry-code" style="display: inline-block;vertical-align: middle;color: #000000">+966</span>
									</button>
									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton5" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 37px, 0px);margin-left: -10px;">
										<a class="dropdown-item" id="arabic-dd" href="javascript:void(0);">
											...
											<span  style="display: inline-block;vertical-align: middle;color: #000000">+966</span>
										</a>
										<a class="dropdown-item" id="india-dd" href="javascript:void(0);">
											...
											<span  style="display: inline-block;vertical-align: middle;color: #000000">+91</span>
										</a>
										<a class="dropdown-item" id="usa-dd" href="javascript:void(0);">
											...
											<span  style="display: inline-block;vertical-align: middle;color: #000000">+1</span>
										</a>
									</div>
								</div>
							</span>
