...
class FacebookController extends Controller{
    ...
    public function index(){
        ...
        return view($this->module_view_folder.'.facebook.index',$this->arr_view_data);
    }

/***********************************************************************************************/
// facebook Campaign Functionality - By Yogesh Kumawat - Dated 31 May 2021 
/***********************************************************************************************/
    ...
    public function facebook_create(){
            ...
            $this->arr_view_data['user'] = $userID;
             $obj_user  = User::where('id',$userID)
                                   ->first();
            $this->arr_view_data['userData']  = $obj_user;              
            return view($this->module_view_folder.'.facebook.create',$this->arr_view_data);
    }
    function store_facebook_data(Request $request){    
        $campaign_id =0;
        ...
        if($request->hasFile('campaign_media')){
            foreach($request->file('campaign_media') as $file){
                $name = "facebook-".time().rand(1,100).'.'.$file->extension();
    ...
    function load_facebook_data($enc_id){
